...
./sunny "input=input1.txt;output=output1.txt" 1>1.stdcout 2>1.stderr
...
# For test case 2
./sunny "input=input2.txt;output=output2.txt" 1>1.stdcout 2>1.stderr
...
# For test case 3
./sunny "input=input3.txt;output=output3.txt" 1>1.stdcout 2>1.stderr
...
# For test case 4
./sunny "input=input4.txt;output=output4.txt" 1>1.stdcout 2>1.stderr
...
./sunny "input=input5.txt;output=output5.txt" 1>1.stdcout 2>1.stderr
...
./sunny "input=input6.txt;output=output6.txt" 1>1.stdcout 2>1.stderr
...
./sunny "input=input7.txt;output=output7.txt" 1>1.stdcout 2>1.stderr
...
./sunny "input=input8.txt;output=output8.txt" 1>1.stdcout 2>1.stderr
...
./sunny "input=input9.txt;output=output9.txt" 1>1.stdcout 2>1.stderr
...
./sunny "input=input10.txt;output=output10.txt" 1>1.stdcout 2>1.stderr
...
echo -e "\033[1;31mWARNING! Input 8's with empty lines was intentional. Aside from that, these test cases were done partially by hand so if you have any issues with them, please let Shehzad know.\033[0m"
read